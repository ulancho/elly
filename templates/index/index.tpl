   ...
   <section class="content">
      ...
      <div class="box box-default ">
         ...
         <div class="box-body">
			...
			<h2 id = "header company"></h2>	
			
			<div class="modal fade" id="modelWindowHistory">
				<div class="modal-dialog modal-sm vertical-align-center" style="    margin: 50px 235px;">
					<div class="modal-content" id = "userhistory" style="width: 900px;
